...
class __Mustache_87eb04b1b58f23efa2a50b2196e8bb80 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionCe089c1056ac8ec0ac98fbc8e5d9eb7f($context, $indent, $value);
        $value = $context->find('haschildren');
        if (empty($value)) {
...
';
            ...
            if (empty($value)) {
                ...
                $buffer .= $this->section2aadd531c16073895e252b50e4b16790($context, $indent, $value);
                $value = $context->find('is_action_link');
                if (empty($value)) {
...
';
    ...
    private function section03f38cccc21845edbb349d6664d75ac5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section06b3e5ac2f48f95e397916e70c69e745(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                if (empty($value)) {
                    ...
                    $value = $context->find('is_action_link');
                    $buffer .= $this->section03f38cccc21845edbb349d6664d75ac5($context, $indent, $value);
                    $value = $context->find('is_action_link');
                    if (empty($value)) {
...
';
    ...
    private function sectionCe089c1056ac8ec0ac98fbc8e5d9eb7f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section06b3e5ac2f48f95e397916e70c69e745($context, $indent, $value);
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '    </li>
';
...
';
    ...
    private function section2aadd531c16073895e252b50e4b16790(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
